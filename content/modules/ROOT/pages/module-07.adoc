...
. You should now see the *docling-markdown-review.md* file in minio_utilities directory. Open the *docling-markdown-review.md* file.
+
When preparing your markdown files for InstructLab it very important that this file contains properly formatted data and domain specific data for the intended use case. 
+
In most cases generated markdown files will need to be manually edited to make sure the context is correct.
+
For this lab we'll assume that you made the appropriate changes and the markdown file contains the correct data for the intended use case and renamed the approved version as *docling-markdown-approved.md*.
+ 
