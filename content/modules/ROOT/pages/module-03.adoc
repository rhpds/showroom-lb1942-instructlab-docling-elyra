...
+
image::openshift/openshift-login-page.png[OpenShift Login,100%,100%]

. Click on the *rhsso* button.

+
image::openshift/openshift-rhsso-page.png[Login with rhsso,100%,100%]

. Enter your *username* and *password* for the lab and click on *Sign In*.

+
image::openshift/openshift-userpass-page.png[Login with username and password,100%,100%]
...
. We'll now take a look at the data science pipeline. This pipeline looks the same as our local pipeline, but some of the node implementations are a little different. 
